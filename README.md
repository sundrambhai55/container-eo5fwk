...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eo5fwk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eo5fwk.containers.anotherwebservice.com/
...
```
git clone git@github.com:sundrambhai55/container-eo5fwk.git
cd container-eo5fwk
```
...
```
docker attach container-eo5fwk
```
